/*
 * RD9 Solutions MiiA.bit HM10 Bluetooth Module Configuration
...
char input;
const char *name_cmd_first = "AT+NAMEmiiabit";
...
void setup () {
    ...
    Serial.println("RD9 MiiA.bit Bluetooth Module Configuration");
...
void configure_hm10_module(void )
{
    ...
    Serial.print("Robot serial number: miiabit");
